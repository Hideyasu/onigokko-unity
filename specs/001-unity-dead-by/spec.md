...
5. **前提** 鬼が陰陽師の 5m 以内にいる、**とき** 鬼が攻撃ボタンを押す、**ならば** 魂を吸う演出が発生し、陰陽師の体力が 1/3 減少する
6. **前提** 陰陽師の体力が 0 になった、**とき** 最後の攻撃を受ける、**ならば** 陰陽師は倒された状態になり、観戦モードに移行する

#### トラップシステム

7. **前提** 陰陽師がトラップを設置済み、**とき** 鬼がトラップから半径 5m 以内に入る、**ならば** トラップが発動し、鬼の攻撃が 30 秒間封印される
